...
const Sun = () => (
  <svg
    ...
    viewBox="0 0 20 20"
    fill="currentColor"
    className="group:hover:text-gray-100 size-6"
  >
    <path
      fillRule="evenodd"
...
const Blank = () => <svg className="size-6" />
              ...
              <div className="p-1">
                <Radio value="light">
                  <MenuItem>
                    {({ focus }) => (
                      <button
                        className={`${focus ? 'bg-primary-600 text-white' : ''} group flex w-full items-center rounded-md p-2 text-sm`}
                      >
                        <div className="mr-2">
                          <Sun />
                        </div>
